...
export default function VerifyLogin() {
  ...
  const sendVerificationCode = async() => {
    ...
    await axios.post(url, {phoneNumber : getCredentials.phoneNumber, dialCode : getCredentials.dialCode}).then((result) => {
  ...
  return (
    ...
    <div className="mx-auto md:h-screen ">
        <div className="flex flex-col justify-center px-6 py-8 h-screen w-max">
            <div className="bg-white rounded-lg sm:max-w-xl xl:p-0 shadow-lg">
